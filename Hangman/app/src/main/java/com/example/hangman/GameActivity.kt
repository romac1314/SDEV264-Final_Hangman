...
class GameActivity : AppCompatActivity() {
    ...
    private val gameManager = GameplayCode()
    ...
    private fun updateUI(gameState: PlayState) {
        when (gameState) {
            is PlayState.Lost -> showGameLost(gameState.wordToGuess)
            is PlayState.Running -> {
            ...
            is PlayState.Won -> showGameWon(gameState.wordToGuess)
        }
    }
    ...
    private fun showGameLost(wordToGuess: String) {
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.hm8))
